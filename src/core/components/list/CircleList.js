...
export default class CircleList extends PureComponent {
  ...
  static propTypes = {
    ...
    renderCard: PropTypes.elementType.isRequired,
    onCurrentItem: PropTypes.func,
    renderText: PropTypes.elementType.isRequired,
  }

  constructor(props) {
    super(props)

    const { data, elementCount, visibilityPadding, onCurrentItem } = props
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (_, gestureState) => {
        ...
        this.props.onCurrentItem(data[selectedIndex])
  ...
  componentDidMount() {
    ...
    // const { breakpoints, theta } = this.state
    // const selectedIndex = this._getClosestIndex(
    //   this.rotationOffset,
    //   breakpoints,
    //   theta,
  ...
  render() {
    const { containerStyle, radius, renderCard, renderText } = this.props
